...
import { ControlTableRowList } from "./controlTable.types"
...
const LidotelTable = ({ headers, rows, thPadding, itemsCount, loading, pagination }: ControlTableProps) => {
    return (
        <TableContainer 
            bg='white'
            border='1px' 
