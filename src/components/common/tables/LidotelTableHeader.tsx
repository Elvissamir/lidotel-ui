...
import { ControlTableHeaderField } from "./controlTable.types"

interface LidotelTableHeaderProps {
    headerData: ControlTableHeaderField
}

const LidotelTableHeader = ({ headerData }: LidotelTableHeaderProps) => {
    return (
...
export default LidotelTableHeader