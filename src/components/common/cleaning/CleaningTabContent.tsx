...
import CleaningTableRows from "./CleaningTableRows"
import CleaningTable from "./CleaningTable"
import useCleaningTable from "../../../hooks/cleaning/useCleaningTable"
...
const CleaningTabContent = () => {
    const { 
        ...
        goToPreviousPage,
        gotToLastPage,
        isFetchingData} = useCleaningTable()
    ...
    return (
        <Flex flexDir='column' w='full'> 
            ...
            <CleaningTable  
                ...
                rows={<CleaningTableRows
                    isDeleting={isDeletingOrder}
                    onEdit={() => null}
                    onDelete={onDeleteOrder}
                    cleaningRequestList={paginatedData} />}
